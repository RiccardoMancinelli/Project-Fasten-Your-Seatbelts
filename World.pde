class World {
  ...
  int wolkid = 0, cloudMax = 128, itemMax = 64, totalLevels = 40, totalLevelshard = 16, hardlimit = 80;        //Alle plaatsbare items initializen. Hardlimit is de level cap waarop we de moeilijke levels gaan gebruiken.
